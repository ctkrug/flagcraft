...
- [x] **1.1 Live grading of pasted `--help` text with guideline citations (wow moment)**
...
- [x] **1.2 One-click famous-CLI presets**
...
- [x] **1.3 Design polish pass for the grader shell**
...
- [x] **2.1 Ambiguous short-flag reuse detection across a command tree**
...
- [x] **2.3 Exit code convention check**
...
- [x] **3.1 Parse argparse-style help text**
...
- [x] **3.4 Parse commander-style help text**
  - A fixture of real Node commander.js `--help` output (comma-separated short/long pairs)
    parses every documented flag correctly.

- [x] **3.5 Graceful handling of malformed or non-CLI pasted text**
